...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-6">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Join Us as an Employee</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="/auth/register" method="POST">
            ...
            <div>
                <label for="bdate" class="block text-sm/6 font-medium text-gray-900">Birdth Date</label>
                <div class="mt-2">
            ...
            <div>
                ...
                <input type="text" name="utype" value="">
        ...
        <p class="mt-10 text-center text-sm/6 text-gray-500">
            ...
            <a href="/auth/login-form" class="font-semibold text-indigo-600 hover:text-indigo-500">Try to login</a>
        </p>
    </div>
</div>
