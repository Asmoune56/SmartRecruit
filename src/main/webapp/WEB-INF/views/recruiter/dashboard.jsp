...
<div class="ml-[300px] mr-[16px] my-[16px]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <h3 class="text-sm font-medium text-gray-500">My Offers</h3>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <h3 class="text-sm font-medium text-gray-500">My Employees</h3>
...
<%--            </div>--%>
<%--            <h3 class="text-sm font-medium text-gray-500">My Inscriptions</h3>--%>
<%--            <p class="text-2xl font-semibold text-gray-900 mt-1">10</p>--%>
<%--        </div>--%>
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center justify-between mb-4">
            ...
            <h3 class="text-sm font-medium text-gray-500">My Enrollments</h3>
            <p class="text-2xl font-semibold text-gray-900 mt-1">10</p>
        </div>
